...
namespace teamseven.EzExam.Services.Services.UserSubscriptionService
{
    public class UserSubscriptionService : IUserSubscriptionService
    {
        ...
        public async Task UpdateAsync(UserSubscriptionResponse subscription)
        {
            ...
            // C?p nh?t các tru?ng t? subscription (gi? s? các giá tr? dã du?c thay d?i trong HandleWebhook)
            ...
            existingSubscription.UpdatedAt = DateTime.UtcNow; // C?p nh?t th?i gian hi?n t?i (24/07/2025 08:34 AM UTC)
